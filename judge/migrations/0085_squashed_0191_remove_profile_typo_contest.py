# Generated by Django 4.2.20 on 2025-04-26 07:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(
                        help_text="code for this contest level",
                        max_length=50,
                        unique=True,
                        verbose_name="code",
                    ),
                ...
                (
                    "about",
                    models.CharField(
                        help_text="detail for this contest level",
                        max_length=255,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_publish",
                    models.BooleanField(
                        db_index=True, default=False, verbose_name="Publish"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Name of the curriculum",
                        max_length=255,
                        verbose_name="name",
                    ),
                ),
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Description of the curriculum",
                        verbose_name="description",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Description of the contest in the curriculum",
                        max_length=255,
                        verbose_name="description",
                    ),
                ),
                (
                    ...
                    models.IntegerField(
                        default=0,
                        help_text="Order of the contest in the curriculum",
                        verbose_name="order",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "object_title",
                    models.CharField(max_length=255, verbose_name="object title"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=20, unique=True, verbose_name="problem class ID"
                    ),
                ),
                (
                    "full_name",
                    models.CharField(max_length=100, verbose_name="problem class name"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        default=0,
                        help_text="Order of the problem in the curriculum",
                        verbose_name="order",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="curriculum_problems",
                        to="judge.curriculum",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_full_markup",
                    models.BooleanField(default=False, verbose_name="markup full"),
                ),
                (
                    "summary",
                    models.TextField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    models.TextField(
                        blank=True, max_length=65536, verbose_name="origin source"
                    ),
                ),
            ],
        ),
        ...
        migrations.AlterModelOptions(
            ...
            options={
                "permissions": (
                    ...
                    ("download_rank_contest", "Download rank of contest"),
                ),
                "verbose_name": "contest",
        ...
        migrations.AlterModelOptions(
            ...
            options={
                "ordering": ("order",),
                "permissions": (
                    ("view_all_contest_problem", "View all contest problem"),
                ),
        ...
        migrations.AddField(
            ...
            field=models.TextField(
                blank=True,
                help_text="Words that are forbidden in the source code.",
                verbose_name="forbidden words",
            ),
        ),
        migrations.AddField(
            model_name="contest",
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(
                default=False, verbose_name="language restriction"
            ),
        ),
        migrations.AddField(
            model_name="contest",
        ...
        migrations.AddField(
            ...
            name="topic",
            field=models.CharField(
                blank=True, max_length=100, verbose_name="contest topic"
            ),
        ),
        migrations.AddField(
            model_name="contest",
        ...
        migrations.AddField(
            ...
            name="limit_point",
            field=models.IntegerField(
                blank=True, default=0, null=True, verbose_name="limit point"
            ),
        ),
        migrations.AddField(
            model_name="language",
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(
                default=False,
                help_text="Only superuser can view link",
                verbose_name="Admin view",
            ),
        ),
        migrations.AddField(
            model_name="organization",
        ...
        migrations.AddField(
            ...
            field=models.IntegerField(
                ...
                default=1000,
                verbose_name="Rate of Organization",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(
                default=False, verbose_name="public description' problem"
            ),
        ),
        migrations.AddField(
            model_name="problem",
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(
                default=False, verbose_name="can download all testcases"
            ),
        ),
        migrations.AddField(
            model_name="profile",
        ...
        migrations.AddField(
            ...
            field=models.DateTimeField(
                default=judge.models.profile.get_default_time,
                verbose_name="last change fullname",
            ),
        ),
        migrations.AddField(
            model_name="profile",
            name="last_name",
            field=models.CharField(
                default=None, max_length=255, null=True, verbose_name="prev name"
            ),
        ),
        migrations.AddField(
            model_name="profile",
        ...
        migrations.AlterField(
            ...
            name="name",
            field=models.CharField(
                db_index=True, max_length=20, verbose_name="contest name"
            ),
        ),
        migrations.AlterField(
            model_name="contest",
        ...
        migrations.AlterField(
            ...
            name="name",
            field=models.CharField(
                max_length=20, unique=True, verbose_name="problem type ID"
            ),
        ),
        migrations.AlterField(
            model_name="profile",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="curriculum_contests",
                to="judge.curriculum",
                verbose_name="curriculum",
            ),
        ),
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True,
                help_text="Contests in the curriculum",
                through="judge.CurriculumContest",
                to="judge.contest",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True,
                help_text="Problems in the curriculum",
                through="judge.PublicProblem",
                to="judge.problem",
        ...
        migrations.AddField(
            ...
            name="classes",
            field=models.ForeignKey(
                help_text="The class of problem, shown under Class in the problem list.",
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
                to="judge.problemclass",
                verbose_name="problem class",
            ),
        ),
        migrations.AlterUniqueTogether(
